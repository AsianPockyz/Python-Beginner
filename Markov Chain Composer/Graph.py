# This is the Makrov Chain representation
import random
...
class Vertex(object):
    ...
    def next_word(self):
        # randomly select next word based on weighting 
        return random.choices(self.neighbors, self.neighbors_weights)[0]


# Now that there is a vertex representation, we put this together in a graph
class Graph(object):
    def __init__(self):
        self.vertices = {}
    ...
    def get_vertex(self, value):
        # what if the vlaue isn't in the graph
